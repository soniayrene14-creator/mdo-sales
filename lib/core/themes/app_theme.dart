...
class AppTheme {
  ...
  Color _primaryColor = AppColors.lightGreen;
  Color? _secondaryColor = AppColors.gray;
  Color? _tertiaryColor = AppColors.darkGray;
  ...
  ThemeData _base({
    ...
    return ThemeData(
      ...
      dividerTheme: DividerThemeData(color: colorScheme.surfaceDim, thickness: 0.5),
      snackBarTheme: SnackBarThemeData(
        behavior: SnackBarBehavior.floating,
        backgroundColor: colorScheme.primary,
        contentTextStyle: textTheme.labelSmall?.copyWith(color: colorScheme.surface, fontWeight: FontWeight.w600),
        showCloseIcon: true,
        elevation: 1,
      ),
