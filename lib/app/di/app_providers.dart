...
import '../../core/services/document/document_download_service.dart';
...
import '../../data/repositories/proforma_repository_impl.dart';
...
final tokenStorageServiceProvider = Provider<TokenStorageService>(
  (ref) => TokenStorageService(ref.watch(sharedPreferencesProvider)),
);
...
// Api Client
final apiClientProvider = Provider<ApiClient>((ref) => ApiClient(baseUrl: Constants.baseUrl));

final documentDownloadServiceProvider = Provider<DocumentDownloadService>(
  (ref) => DocumentDownloadService(ref.watch(apiClientProvider)),
);

// Remote Datasources
final authRemoteDataSourceProvider = Provider<AuthDjangoRemoteDataSourceImpl>(
  (ref) => AuthDjangoRemoteDataSourceImpl(
    apiClient: ref.watch(apiClientProvider),
    tokenStorage: ref.watch(tokenStorageServiceProvider),
  ),
);
final productRemoteDatasourceProvider = Provider<ProductDjangoRemoteDataSourceImpl>(
  (ref) => ProductDjangoRemoteDataSourceImpl(
    apiClient: ref.watch(apiClientProvider),
  ),
);
final transactionRemoteDatasourceProvider = Provider<TransactionDjangoRemoteDataSourceImpl>(
  (ref) => TransactionDjangoRemoteDataSourceImpl(
    apiClient: ref.watch(apiClientProvider),
  ),
);
