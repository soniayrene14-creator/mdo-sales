...
class _ConnectionTypeDropDown extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AppDropDown<PrinterConnectionType>.multi(
      labelText: 'Types de connexion',
      hintText: 'Sélectionner les types de connexion',
      enabled: !isBusy,
  ...
  String _label(PrinterConnectionType type) {
    return switch (type) {
      ...
      PrinterConnectionType.network => 'Réseau',
    };
  }
  ...
  String _selectedLabel(Set<PrinterConnectionType> selectedTypes) {
    if (selectedTypes.length == PrinterConnectionType.values.length) {
      return 'Tous les types de connexion';
    }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (printers.isEmpty) {
      return Padding(
        ...
        child: Center(
          child: Text(
            isScanning ? 'Recherche d\'imprimantes...' : '(Aucune imprimante détectée)',
